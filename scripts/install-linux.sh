...
BINARY_NAME="cloud-governance"
ALIAS_NAME="bluearch-aws-governance"
ASSET_NAME="cloud-governance-linux-x86_64.tar.gz"
...
case "$(uname -s)" in
  Linux) ;;
  *) fail "This installer supports Linux only. On macOS, use: brew install bluearchio/tap/bluearch-aws-governance" ;;
esac
